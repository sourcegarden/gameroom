	...
	var Spirit = Block.subClass( function( config ){
			...
			this.shadow = null;	  //��Ӱ
			this.queue = null;		//��������
			this.keyManage = null;//���̹���
			this.collision = null;//��ײ���
			this.attack = null;   //����
			this.waveBoxing = null; //����ȭ
			this.status = null;   //����״̬��, �����������м�ʱ״̬
			this.bloodBar = null;
...

		{
			init: function( f_left, f_top, direction ){
				...
				this.collision = this.implement( 'Collision' );  //����, ���ƶ�, ������
			...
			play: function( state, force ){
				...
				if ( this.statusManage.isCrouch() && ( state === 'wait' || state === 'force_wait' ) ){  //���µ�״̬վ����.	
